...
/**
 * SQL Map file is not written for now
 */
@Stateless
public class ProductDaoImpl implements ProductDao {
    ...
    public List<Product> findAll() {
        try {
            return sqlMapClient.queryForList("getAllProducts");
    ...
    public Product findOne(Integer id) {
        try {
            return (Product) sqlMapClient.queryForObject("getProductById", id);
        } catch (SQLException e) {
            logger.error("Got exception on select query: ", e);
            throw new NoProductFoundException(e);
        }
    ...
    public void create(Product entity) {
        try {
            sqlMapClient.insert("insertProduct", entity);
        } catch (SQLException e) {
    ...
    public void update(Product entity) {
        try {
            sqlMapClient.update("updateProduct", entity);
        } catch (SQLException e) {
    ...
    public void delete(Integer id) {
        try {
            sqlMapClient.delete("deleteProduct", id);
        } catch (SQLException e) {
    ...
    public List<Product> findAllByCategory(String categoryName) {
        try {
            return sqlMapClient.queryForList("getAllProductByCategory", categoryName);
        } catch (SQLException e) {
            logger.error("Got exception on select query: ", e);
            throw new NoProductFoundException(e);
        }
